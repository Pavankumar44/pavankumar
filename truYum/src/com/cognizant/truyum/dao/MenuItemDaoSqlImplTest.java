...
public class MenuItemDaoSqlImplTest {
	...
	public static void testGetMenuItemListAdmin()
	{
		...
		try {
			...
			for (MenuItem items : menuItems) {
				...
				System.out.println(String.format(items.getName(),items.getPrice(),items.isActive(),simple.format(items.getDateOfLaunch()),items.getCategory(),items.isFreeDelivery()));
	...
	public static void testmodifyMenuItem()
	{
		try {
			...
			System.out.println(String.format(menuItem.getName(),menuItem.getPrice(),menuItem.isActive(),simple.format(menuItem.getDateOfLaunch()),menuItem.getCategory(),menuItem.isFreeDelivery()));
